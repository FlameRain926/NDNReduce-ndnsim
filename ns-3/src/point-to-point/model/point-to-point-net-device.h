...
private:
  ...
  TracedCallback<Ptr<const Packet>, uint32_t, uint32_t > m_macTxTraceDetail;
  ...
  TracedCallback<Ptr<const Packet>, uint32_t, uint32_t > m_macTxDropTraceDetail;
  ...
  TracedCallback<Ptr<const Packet>,uint32_t , uint32_t > m_phyTxBeginTraceDetail;
  ...
  TracedCallback<Ptr<const Packet>,uint32_t, uint32_t > m_phyTxEndTraceDetail;
  ...
  TracedCallback<Ptr<const Packet>,uint32_t, uint32_t > m_phyTxDropTraceDetail;
  ...
  TracedCallback<Ptr<const Packet>, uint32_t, uint32_t > m_phyRxEndTraceDetail;
  ...
  TracedCallback<Ptr<const Packet>, uint32_t, uint32_t > m_phyRxDropTraceDetail;
