...
uint64_t allgatherBytes[108] = {0};
uint64_t txBytes[108] = {0};
uint64_t DropBytes[108] = {0};
uint32_t scattersign[108] = {0};
static int32_t debug_trace = 0;
static int32_t allgather_sign = 0;
static int32_t scatter_sign = 0;
static std::ofstream testFile("dragonfly_100M_timeout.txt");
static std::ofstream test_machine0("dragonfly_100M_send.txt");
static std::ofstream test_machine0_hop("dragonfly_100M_receive.txt");
static std::ofstream test_machine0_cubic("dragonfly_100M_cubicaction.txt");
...
main(int argc, char* argv[])
{
  ...
  p2p.Install(nodes.Get(1), nodes.Get(72));
  p2p.Install(nodes.Get(2), nodes.Get(73));
  p2p.Install(nodes.Get(3), nodes.Get(73));
  p2p.Install(nodes.Get(4), nodes.Get(74));
  p2p.Install(nodes.Get(5), nodes.Get(74));
  p2p.Install(nodes.Get(6), nodes.Get(75));
  p2p.Install(nodes.Get(7), nodes.Get(75));


  /*pod1*/
  p2p.Install(nodes.Get(8), nodes.Get(76));
  p2p.Install(nodes.Get(9), nodes.Get(76));
  p2p.Install(nodes.Get(10), nodes.Get(77));
  p2p.Install(nodes.Get(11), nodes.Get(77));
  p2p.Install(nodes.Get(12), nodes.Get(78));
  p2p.Install(nodes.Get(13), nodes.Get(78));
  p2p.Install(nodes.Get(14), nodes.Get(79));
  p2p.Install(nodes.Get(15), nodes.Get(79));

  /*pod2*/
  p2p.Install(nodes.Get(16), nodes.Get(80));
  p2p.Install(nodes.Get(17), nodes.Get(80));
  p2p.Install(nodes.Get(18), nodes.Get(81));
  p2p.Install(nodes.Get(19), nodes.Get(81));
  p2p.Install(nodes.Get(20), nodes.Get(82));
  p2p.Install(nodes.Get(21), nodes.Get(82));
  p2p.Install(nodes.Get(22), nodes.Get(83));
  p2p.Install(nodes.Get(23), nodes.Get(83));

  /*pod3*/
  p2p.Install(nodes.Get(24), nodes.Get(84));
  p2p.Install(nodes.Get(25), nodes.Get(84));
  p2p.Install(nodes.Get(26), nodes.Get(85));
  p2p.Install(nodes.Get(27), nodes.Get(85));
  p2p.Install(nodes.Get(28), nodes.Get(86));
  p2p.Install(nodes.Get(29), nodes.Get(86));
  p2p.Install(nodes.Get(30), nodes.Get(87));
  p2p.Install(nodes.Get(31), nodes.Get(87));

  /*pod4*/
  p2p.Install(nodes.Get(32), nodes.Get(88));
  p2p.Install(nodes.Get(33), nodes.Get(88));
  p2p.Install(nodes.Get(34), nodes.Get(89));
  p2p.Install(nodes.Get(35), nodes.Get(89));
  p2p.Install(nodes.Get(36), nodes.Get(90));
  p2p.Install(nodes.Get(37), nodes.Get(90));
  p2p.Install(nodes.Get(38), nodes.Get(91));
  p2p.Install(nodes.Get(39), nodes.Get(91));

  /*pod5*/
  p2p.Install(nodes.Get(40), nodes.Get(92));
  p2p.Install(nodes.Get(41), nodes.Get(92));
  p2p.Install(nodes.Get(42), nodes.Get(93));
  p2p.Install(nodes.Get(43), nodes.Get(93));
  p2p.Install(nodes.Get(44), nodes.Get(94));
  p2p.Install(nodes.Get(45), nodes.Get(94));
  p2p.Install(nodes.Get(46), nodes.Get(95));
  p2p.Install(nodes.Get(47), nodes.Get(95));

  /*pod6*/
  p2p.Install(nodes.Get(48), nodes.Get(96));
  p2p.Install(nodes.Get(49), nodes.Get(96));
  p2p.Install(nodes.Get(50), nodes.Get(97));
  p2p.Install(nodes.Get(51), nodes.Get(97));
  p2p.Install(nodes.Get(52), nodes.Get(98));
  p2p.Install(nodes.Get(53), nodes.Get(98));
  p2p.Install(nodes.Get(54), nodes.Get(99));
  p2p.Install(nodes.Get(55), nodes.Get(99));

  /*pod7*/
  p2p.Install(nodes.Get(56), nodes.Get(100));
  p2p.Install(nodes.Get(57), nodes.Get(100));
  p2p.Install(nodes.Get(58), nodes.Get(101));
  p2p.Install(nodes.Get(59), nodes.Get(101));
  p2p.Install(nodes.Get(60), nodes.Get(102));
  p2p.Install(nodes.Get(61), nodes.Get(102));
  p2p.Install(nodes.Get(62), nodes.Get(103));
  p2p.Install(nodes.Get(63), nodes.Get(103));

  /*pod8*/
  p2p.Install(nodes.Get(64), nodes.Get(104));
  p2p.Install(nodes.Get(65), nodes.Get(104));
  p2p.Install(nodes.Get(66), nodes.Get(105));
  p2p.Install(nodes.Get(67), nodes.Get(105));
  p2p.Install(nodes.Get(68), nodes.Get(106));
  p2p.Install(nodes.Get(69), nodes.Get(106));
  p2p.Install(nodes.Get(70), nodes.Get(107));
  p2p.Install(nodes.Get(71), nodes.Get(107));

  /*inner-pod*/
  p2p.Install(nodes.Get(72), nodes.Get(73));
  p2p.Install(nodes.Get(72), nodes.Get(74));
  ...
  p2p.Install(nodes.Get(76), nodes.Get(78));
  p2p.Install(nodes.Get(76), nodes.Get(79));
  p2p.Install(nodes.Get(77), nodes.Get(78));
  p2p.Install(nodes.Get(77), nodes.Get(79));
  ...
  p2p.Install(nodes.Get(81), nodes.Get(83));
  p2p.Install(nodes.Get(82), nodes.Get(83));

  p2p.Install(nodes.Get(84), nodes.Get(85));
  p2p.Install(nodes.Get(84), nodes.Get(86));
  ...
  p2p.Install(nodes.Get(88), nodes.Get(90));
  p2p.Install(nodes.Get(88), nodes.Get(91));
  p2p.Install(nodes.Get(89), nodes.Get(90));
  p2p.Install(nodes.Get(89), nodes.Get(91));
  p2p.Install(nodes.Get(90), nodes.Get(91));

  p2p.Install(nodes.Get(92), nodes.Get(93));
  p2p.Install(nodes.Get(92), nodes.Get(94));
  p2p.Install(nodes.Get(92), nodes.Get(95));
  p2p.Install(nodes.Get(93), nodes.Get(94));
  p2p.Install(nodes.Get(93), nodes.Get(95));
  p2p.Install(nodes.Get(94), nodes.Get(95));

  p2p.Install(nodes.Get(96), nodes.Get(97));
  p2p.Install(nodes.Get(96), nodes.Get(98));
  p2p.Install(nodes.Get(96), nodes.Get(99));
  p2p.Install(nodes.Get(97), nodes.Get(98));
  p2p.Install(nodes.Get(97), nodes.Get(99));
  p2p.Install(nodes.Get(98), nodes.Get(99));

  p2p.Install(nodes.Get(100), nodes.Get(101));
  p2p.Install(nodes.Get(100), nodes.Get(102));
  p2p.Install(nodes.Get(100), nodes.Get(103));
  p2p.Install(nodes.Get(101), nodes.Get(102));
  p2p.Install(nodes.Get(101), nodes.Get(103));
  p2p.Install(nodes.Get(102), nodes.Get(103));

  p2p.Install(nodes.Get(104), nodes.Get(105));
  p2p.Install(nodes.Get(104), nodes.Get(106));
  p2p.Install(nodes.Get(104), nodes.Get(107));
  p2p.Install(nodes.Get(105), nodes.Get(106));
  p2p.Install(nodes.Get(105), nodes.Get(107));
  p2p.Install(nodes.Get(106), nodes.Get(107));

  /*inter-pod*/
  p2p.Install(nodes.Get(72), nodes.Get(107));
  p2p.Install(nodes.Get(72), nodes.Get(103));
  p2p.Install(nodes.Get(73), nodes.Get(98));
  p2p.Install(nodes.Get(73), nodes.Get(94));
  p2p.Install(nodes.Get(74), nodes.Get(89));
  p2p.Install(nodes.Get(74), nodes.Get(85));
  p2p.Install(nodes.Get(75), nodes.Get(80));
  p2p.Install(nodes.Get(75), nodes.Get(76));

  p2p.Install(nodes.Get(76), nodes.Get(107));
  p2p.Install(nodes.Get(77), nodes.Get(102));
  p2p.Install(nodes.Get(77), nodes.Get(98));
  p2p.Install(nodes.Get(78), nodes.Get(93));
  p2p.Install(nodes.Get(78), nodes.Get(89));
  p2p.Install(nodes.Get(79), nodes.Get(84));
  p2p.Install(nodes.Get(79), nodes.Get(80));

  p2p.Install(nodes.Get(81), nodes.Get(106));
  p2p.Install(nodes.Get(81), nodes.Get(102));
  p2p.Install(nodes.Get(82), nodes.Get(97));
  p2p.Install(nodes.Get(82), nodes.Get(93));
  p2p.Install(nodes.Get(83), nodes.Get(88));
  p2p.Install(nodes.Get(83), nodes.Get(84));

  p2p.Install(nodes.Get(85), nodes.Get(106));
  p2p.Install(nodes.Get(86), nodes.Get(101));
  p2p.Install(nodes.Get(86), nodes.Get(97));
  p2p.Install(nodes.Get(87), nodes.Get(92));
  p2p.Install(nodes.Get(87), nodes.Get(88));

  p2p.Install(nodes.Get(90), nodes.Get(105));
  p2p.Install(nodes.Get(90), nodes.Get(101));
  p2p.Install(nodes.Get(91), nodes.Get(96));
  p2p.Install(nodes.Get(91), nodes.Get(92));

  p2p.Install(nodes.Get(94), nodes.Get(105));
  p2p.Install(nodes.Get(95), nodes.Get(100));
  p2p.Install(nodes.Get(95), nodes.Get(96));

  p2p.Install(nodes.Get(99), nodes.Get(104));
  ...
  consumerHelper.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper.SetAttribute("TotalMachineNumber",StringValue("72"));
  ...
  consumerHelper1.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper1.SetAttribute("TotalMachineNumber",StringValue("72"));
  ...
  consumerHelper2.SetPrefix("/2");
  consumerHelper2.SetAttribute("MachineRank",StringValue("2"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ...
  consumerHelper2.SetPrefix("/54");
  consumerHelper2.SetAttribute("MachineRank",StringValue("54"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/54", nodes.Get(54));
  auto apps54 = consumerHelper2.Install(nodes.Get(54));  

  consumerHelper2.SetPrefix("/55");
  consumerHelper2.SetAttribute("MachineRank",StringValue("55"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/55", nodes.Get(55));
  auto apps55 = consumerHelper2.Install(nodes.Get(55));  

  consumerHelper2.SetPrefix("/56");
  consumerHelper2.SetAttribute("MachineRank",StringValue("56"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/56", nodes.Get(56));
  auto apps56 = consumerHelper2.Install(nodes.Get(56));  

  consumerHelper2.SetPrefix("/57");
  consumerHelper2.SetAttribute("MachineRank",StringValue("57"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/57", nodes.Get(57));
  auto apps57 = consumerHelper2.Install(nodes.Get(57));  

  consumerHelper2.SetPrefix("/58");
  consumerHelper2.SetAttribute("MachineRank",StringValue("58"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/58", nodes.Get(58));
  auto apps58 = consumerHelper2.Install(nodes.Get(58)); 

  consumerHelper2.SetPrefix("/59");
  consumerHelper2.SetAttribute("MachineRank",StringValue("59"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/59", nodes.Get(59));
  auto apps59 = consumerHelper2.Install(nodes.Get(59)); 

  consumerHelper2.SetPrefix("/60");
  consumerHelper2.SetAttribute("MachineRank",StringValue("60"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/60", nodes.Get(60));
  auto apps60 = consumerHelper2.Install(nodes.Get(60));  

  consumerHelper2.SetPrefix("/61");
  consumerHelper2.SetAttribute("MachineRank",StringValue("61"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/61", nodes.Get(61));
  auto apps61 = consumerHelper2.Install(nodes.Get(61));  

  consumerHelper2.SetPrefix("/62");
  consumerHelper2.SetAttribute("MachineRank",StringValue("62"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/62", nodes.Get(62));
  auto apps62 = consumerHelper2.Install(nodes.Get(62));  

  consumerHelper2.SetPrefix("/63");
  consumerHelper2.SetAttribute("MachineRank",StringValue("63"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/63", nodes.Get(63));
  auto apps63 = consumerHelper2.Install(nodes.Get(63));  

  consumerHelper2.SetPrefix("/64");
  consumerHelper2.SetAttribute("MachineRank",StringValue("64"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/64", nodes.Get(64));
  auto apps64 = consumerHelper2.Install(nodes.Get(64));  

  consumerHelper2.SetPrefix("/65");
  consumerHelper2.SetAttribute("MachineRank",StringValue("65"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/65", nodes.Get(65));
  auto apps65 = consumerHelper2.Install(nodes.Get(65));  

  consumerHelper2.SetPrefix("/66");
  consumerHelper2.SetAttribute("MachineRank",StringValue("66"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/66", nodes.Get(66));
  auto apps66 = consumerHelper2.Install(nodes.Get(66));  

  consumerHelper2.SetPrefix("/67");
  consumerHelper2.SetAttribute("MachineRank",StringValue("67"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/67", nodes.Get(67));
  auto apps67 = consumerHelper2.Install(nodes.Get(67));  

  consumerHelper2.SetPrefix("/68");
  consumerHelper2.SetAttribute("MachineRank",StringValue("68"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/68", nodes.Get(68));
  auto apps68 = consumerHelper2.Install(nodes.Get(68)); 

  consumerHelper2.SetPrefix("/69");
  consumerHelper2.SetAttribute("MachineRank",StringValue("69"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/69", nodes.Get(69));
  auto apps69 = consumerHelper2.Install(nodes.Get(69)); 

  consumerHelper2.SetPrefix("/70");
  consumerHelper2.SetAttribute("MachineRank",StringValue("70"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/70", nodes.Get(70));
  auto apps70 = consumerHelper2.Install(nodes.Get(70));  

  consumerHelper2.SetPrefix("/71");
  consumerHelper2.SetAttribute("MachineRank",StringValue("71"));
  consumerHelper2.SetAttribute("ModelSize",StringValue("1388"));
  consumerHelper2.SetAttribute("TotalMachineNumber",StringValue("72"));
  ndnGlobalRoutingHelper.AddOrigins("/71", nodes.Get(71));
  auto apps71 = consumerHelper2.Install(nodes.Get(71));  
